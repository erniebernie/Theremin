/*
 ...
 to compile : gcc led_code.c -o ernie -lwiringPi
...
//all on	
  ...
  MAX7219Send(1,0b11111111); //volume 0-8	 

  MAX7219Send(2,0b11000000); //volume 9-10

  MAX7219Send(3,0b11111111); //pitch 0-8		 
  
  MAX7219Send(4,0b11000000); //pitch 9-10	 

    //all off
//
/*
  MAX7219Send(1,0b00000000); //volume 0-8	 
  
  MAX7219Send(2,0b00000000); //volume 9-10
  
  MAX7219Send(3,0b00000000); //pitch 0-8		 
  
  MAX7219Send(4,0b00000000); //pitch 9-10	 
*/  
  return 0;
}
